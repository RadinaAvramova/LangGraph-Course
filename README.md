...
This repo provides practical examples of using [LangGraph](https://github.com/langchain-ai/langgraph) for building agent-based applications through Python scripts and interactive Jupyter notebooks.
...
```zsh
git clone https://github.com/RadinaAvramova/LangGraph-Course.git
cd LangGraph-Course
```
